...
export default function Home() {
  return (
    <>
      <Hero
        title="Kod, Tasarım ve Yaratıcılık"
        subtitle="Flutter, C#, SQL ve Yazılım Geliştirme Dünyası"
      ...
      <section className="container my-24 relative">
        ...
        >
          ...
          <p className="text-lg text-foreground/80">
            Kullanıcı deneyimini merkeze alan, performans odaklı ve estetik web çözümleri geliştiriyorum.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-lg text-foreground/80 relative z-10">
            Mobil ve masaüstü uygulamalar, web siteleri ve veritabanı yönetimi konularında deneyimlerimi paylaşıyorum.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <Card
              ...
              description="Flutter kullanarak iOS ve Android için çapraz platform uygulamalar geliştiriyorum."
          ...
          >
            <Card
              title="C# Form Uygulamaları"
              description="Masaüstü uygulamalar ve iş çözümleri için C# ve .NET teknolojilerini kullanıyorum."
          ...
          >
            <Card
              ...
              description="Modern web teknolojileri ile duyarlı ve performanslı web siteleri oluşturuyorum."
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <Card
                ...
                description="Flutter uygulamalarında durum yönetimi için farklı yaklaşımların karşılaştırılması."
                link="/blog/flutter-state-management"
            ...
            >
              <Card
                ...
                description="Veritabanı sorgularını optimize etmek için temel ipuçları ve stratejiler."
                link="/blog/sql-optimizasyon"
            ...
            >
              <Card
                ...
                description="Projelerinizde Git'i daha etkili kullanmak için ipuçları ve stratejiler."
                link="/blog/git-versiyon-kontrolu"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-4">
                <a href="mailto:iletisim@email.com" className="flex items-center gap-3 text-foreground/80 hover:text-primary transition-colors duration-300">
                  ...
                  <span>iletisim@email.com</span>
                </a>
                
                <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-foreground/80 hover:text-primary transition-colors duration-300">
                  <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                ...
                <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-foreground/80 hover:text-primary transition-colors duration-300">
                  <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary" viewBox="0 0 24 24" fill="currentColor">
